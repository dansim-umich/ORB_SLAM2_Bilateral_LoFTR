...
gnome-terminal --tab --title="play" -- rosbag play --clock --pause -r 0.05 sequence0$1.bag /stereo/left/image_raw:=/camera/left/image_raw /stereo/right/image_raw:=/camera/right/image_raw